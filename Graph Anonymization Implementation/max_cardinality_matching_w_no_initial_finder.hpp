...
//
// Jared Gaertner edits:
// Adding in a case where no initial finder method is needed, as a set
//  of mates has already been found
//=======================================================================

#ifndef BOOST_GRAPH_MAXIMUM_CARDINALITY_MATCHING_W_NO_INITIAL_FINDER_HPP
#define BOOST_GRAPH_MAXIMUM_CARDINALITY_MATCHING_W_NO_INITIAL_FINDER_HPP
...
namespace boost
{
	...
	//  of mates has already been found
	//
	// Adding in custom matching and checked_edmonds_maximum_cardinality_matching 
	//  functions which take in a non-null MateMap of mates, and therefore does 
	//  not need an InitialMatchingFinder
	//
	template <typename Graph,
		typename MateMap,
		typename VertexIndexMap,
	...
	template <typename Graph, typename MateMap, typename VertexIndexMap>
	inline bool checked_edmonds_maximum_cardinality_matching_w_no_initial_finder(const Graph& g, MateMap mate)
	{
		return matching
			< Graph, MateMap, VertexIndexMap,
			edmonds_augmenting_path_finder, maximum_cardinality_matching_verifier>
			(g, mate, vm);
	}
...
#endif //BOOST_GRAPH_MAXIMUM_CARDINALITY_MATCHING_W_NO_INITIAL_FINDER_HPP
